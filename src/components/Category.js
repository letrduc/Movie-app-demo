...
export default function Category() {
  ...
  return (
    <>
      <Typography variant="h5" my={3} fontWeight={600} className="title">
        CATEGORY
      </Typography>
            ...
            >
              <ListItemText
                ...
                secondaryTypographyProps={{
                  ...
                  fontSize: 12,
                  lineHeight: "16px",
                  color: openGenres ? "rgba(0,0,0,0)" : "success",
                }}
                sx={{ my: 0 }}
              />
            ...
            >
              <ListItemText
                ...
                secondaryTypographyProps={{
                  ...
                  fontSize: 12,
                  lineHeight: "16px",
                  color: openYear ? "rgba(0,0,0,0)" : "success",
                }}
                sx={{ my: 0 }}
              />
              <KeyboardArrowDownIcon
            ...
            {openYear &&
              yearList.map((item) => (
                <ListItemButton
                  ...
                  key={item.id}
                  sx={{ py: 0, minHeight: 40, color: "rgb(51,153,102)" }}
                >
                  <ListItemText
                    key={item.id}
                    primary={item.label}
